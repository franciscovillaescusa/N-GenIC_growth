...
#define MAXTAGS 300
  ...
  strcpy(tag[nt], "FileWithBGrowth");
  addr[nt] = FileWithBGrowth;
  id[nt++] = STRING;

  strcpy(tag[nt], "FileWithCDMGrowth");
  addr[nt] = FileWithCDMGrowth;
  id[nt++] = STRING;

  strcpy(tag[nt], "FileWithNUGrowth");
  addr[nt] = FileWithNUGrowth;
  id[nt++] = STRING;
  ...
  strcpy(tag[nt], "RayleighSampling");
  addr[nt] = &RayleighSampling;
  id[nt++] = INT;

  strcpy(tag[nt], "Phase_flip");
  addr[nt] = &Phase_flip;
  id[nt++] = INT;
